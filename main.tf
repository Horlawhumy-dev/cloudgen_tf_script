...
module "load_balancer" {
  ...
  # Add necessary input variables for the Load Balancer module
}

module "autoscaling" {
  source = "./modules/autoscaling"
  # Add necessary input variables for the Auto Scaling module
}

module "rds" {
  source = "./modules/rds"
  # Add necessary input variables for the RDS module
}

# module "security_groups" {
#   source = "./modules/security_groups"
#   # Add necessary input variables for the Security Groups module
# }
